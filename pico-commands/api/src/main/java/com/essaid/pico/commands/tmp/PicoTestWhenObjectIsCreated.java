package com.essaid.pico.commands.tmp;
...
public class PicoTestWhenObjectIsCreated {
  ...
  public static void main(String[] args) {
    ...
    CommandLine a = new CommandLine(com.essaid.pico.commands.tmp.PicoTestWhenObjectIsCreated.A.class);
    

    CommandLine b = new CommandLine(com.essaid.pico.commands.tmp.PicoTestWhenObjectIsCreated.B.class);
    CommandLine c = new CommandLine(com.essaid.pico.commands.tmp.PicoTestWhenObjectIsCreated.C.class);
